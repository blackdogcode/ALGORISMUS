...
//
// Your task is to code upand run the randomized contraction algorithm for the min cut problemand 
...
int main() {
   ...
   ifstream in("kargerMinCut.txt", ifstream::in);
   if (!in.is_open()) {
      cerr << "Erorr: kargerMinCut.txt Not Found!";
      return -1;
   }
   // Correct Output: 17
   return 0;
